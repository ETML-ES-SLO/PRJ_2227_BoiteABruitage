...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_2, 9999);
    /* Setup Interrupt */   
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_4, 452);
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T4, INT_PRIORITY_LEVEL3);
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_1, 3627);
    /* Setup Interrupt */   
