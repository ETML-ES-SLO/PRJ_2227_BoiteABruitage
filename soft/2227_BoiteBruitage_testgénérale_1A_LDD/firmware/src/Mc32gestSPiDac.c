...
//
   ...
   PLIB_SPI_BaudRateSet(KitSpi1, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 20000000);
...
{  
//   TRISDbits.TRISA3 = 0;   //SPI-CS_DA en sortie (RD4)
